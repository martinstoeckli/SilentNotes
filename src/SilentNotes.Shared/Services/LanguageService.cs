...
namespace SilentNotes.Services
{
    ...
    public class LanguageService : LanguageServiceBase
    {
        ...
        private void LoadEnglishResources(Dictionary<string, string> resources)
        {
            ...
            resources["note_shopping_mode"] = "Shopping mode";
            ...
            resources["cloud_accept_invalid_certificate"] = "Accept unsafe certificates.";
        ...
        private void LoadGermanResources(Dictionary<string, string> resources)
        {
            ...
            resources["note_shopping_mode"] = "Einkaufsmodus";
            ...
            resources["cloud_accept_invalid_certificate"] = "Akzeptiere unsichere Zertifikate.";
