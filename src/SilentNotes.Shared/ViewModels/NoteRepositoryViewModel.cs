...
namespace SilentNotes.ViewModels
{
    ...
    public class NoteRepositoryViewModel : ViewModelBase
    {
        ...
        private void AddNote()
        {
            ...
            NoteViewModel noteViewModel = new NoteViewModel(_navigationService, Language, Icon, _webviewBaseUrl, _searchableTextConverter, _repositoryService, noteModel);
        ...
        internal NoteRepositoryModel Model
        {
            ...
            set
            {
                ...
                {
                    NoteViewModel noteViewModel = new NoteViewModel(_navigationService, Language, Icon, _webviewBaseUrl, _searchableTextConverter, _repositoryService, note);
