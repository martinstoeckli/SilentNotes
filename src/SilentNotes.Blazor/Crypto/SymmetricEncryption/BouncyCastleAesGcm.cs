...
namespace SilentNotes.Crypto.SymmetricEncryption
{
    ...
    /// the AES algorithm with the GCM mode. This is an authenticated encryption mode so there is
    /// no need to do additionally authentication afterwards.
    /// This class depends on the BouncyCastle library.
    /// </summary>
    public class BouncyCastleAesGcm : ISymmetricEncryptionAlgorithm
    {
        /// <summary>The name of the Aes encryption algorithm.</summary>
        public const string CryptoAlgorithmName = "aes_gcm";
